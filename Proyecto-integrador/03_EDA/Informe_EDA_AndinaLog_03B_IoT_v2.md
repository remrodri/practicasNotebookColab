...
El EDA responde al mandato del subcaso 03B: **proteger la cadena de frío, mejorar la rotación del inventario y explorar señales para anticipar desviaciones térmicas en los próximos 60 minutos**. El notebook `S4_03_AndinaLog_03B_EDA_Didactico_IoT_v2.ipynb` combina las cuatro salidas didácticas de tratamiento. No modifica los CSV ni entrena un modelo predictivo.
...
|---|---|---:|---|
| IoT | `proyecto-integrador/02_tratamiento/andinalog_iot_telemetry/salidas/andinalog_iot_telemetry_didactico_v2_silver.csv` | 28.677 | Lectura de telemetría. |
...
El notebook está ubicado en `proyecto-integrador/03_EDA/S4_03_AndinaLog_03B_EDA_Didactico_IoT_v2.ipynb`. El EDA usa IoT Silver v2 y las salidas Silver didácticas actuales de los otros tres conjuntos.
...
1. **Hora:** el CSV original sin zona se interpreta como hora de Bolivia. `timestamp_bolivia_tratado` conserva esa hora local validada y ordena las lecturas; no se deriva UTC. Inventario utiliza fechas de calendario sin hora.
